...
class EACommunicator_API:
    ...
    def Get_instrument_info(self,
        ...
        if instrument in self.Symbols:
            ...
            print("[Get_instrument_info] ERROR : {} not exist !".format(instrument))
            return {}
        ...
        if self.Update_instruments(selected):
            for sid in self.Symbols.copy():
                if not self.Get_last_tick_info(sid):
                    print(f'Retreive Tick of {sid} failed ! Remove from symbol list.')
                    self.Symbols.remove(sid)
            return self.Symbols
        else:
            print('[Get_instruments] ERROR : fail !')
            return []
    ...
    def Open_order(self,
        ...
        if instrument in self.Symbols:
            ...
            print("[Open_order] ERROR : {} not exist !".format(instrument))
            return {}
